...
mcp.add_tool(translate_evidence_errors(list_failed_tests))
mcp.add_tool(translate_evidence_errors(get_test_failure))
mcp.add_tool(translate_evidence_errors(inspect_fixture))
mcp.add_tool(translate_evidence_errors(parse_pytest_output))
